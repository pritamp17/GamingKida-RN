...
export class Payment {
    constructor(userId, name, success, transactionId, transactionRef, amount, type, orgId) {
        this.userId = userId;
        this.name = name;
...
export const handleCompetetionJoinSucces = async(userId, txnId, transactionRef, amount, orgId, name) => {
    try {
       const payementId =  savePaymentToFirebase(userId, txnId, transactionRef, amount, COMPETETION_JOIN_SUCCESS, orgId, name);
